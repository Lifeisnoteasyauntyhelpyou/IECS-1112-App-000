...
public class VegetableToast extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_vegetable_toast);
  ...
  public void saveData(){
    AlertDialog.Builder builder = new AlertDialog.Builder(VegetableToast.this);
    ...
    FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
      ...
      public void onComplete(@NonNull Task<Void> task) {
        if(task.isSuccessful()){
          ...
          Toast.makeText(VegetableToast.this, "Saved", Toast.LENGTH_LONG).show();
          finish();
        }
      }
      ...
      public void onFailure(@NonNull Exception e) {
        Toast.makeText(VegetableToast.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
      }
    });
  }
