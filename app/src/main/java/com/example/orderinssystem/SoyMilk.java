...
public class SoyMilk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soy_milk);
        ...
        btSend.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int ice = rgCheese.getCheckedRadioButtonId();
                int sugar = rgVegetable.getCheckedRadioButtonId();
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(SoyMilk.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(SoyMilk.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(SoyMilk.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
