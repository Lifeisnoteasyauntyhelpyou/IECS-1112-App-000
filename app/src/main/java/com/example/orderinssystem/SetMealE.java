...
public class SetMealE extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_meal_e);
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(SetMealE.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(SetMealE.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(SetMealE.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
