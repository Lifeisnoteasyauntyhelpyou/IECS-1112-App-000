...
public class ChickenChopBurger extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_chicken_chop_burger);
  ...
  public void saveData(){
    AlertDialog.Builder builder = new AlertDialog.Builder(ChickenChopBurger.this);
    ...
    FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
      ...
      public void onComplete(@NonNull Task<Void> task) {
        if(task.isSuccessful()){
          ...
          Toast.makeText(ChickenChopBurger.this, "Saved", Toast.LENGTH_LONG).show();
          finish();
        }
      }
      ...
      public void onFailure(@NonNull Exception e) {
        Toast.makeText(ChickenChopBurger.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
      }
    });
  }
