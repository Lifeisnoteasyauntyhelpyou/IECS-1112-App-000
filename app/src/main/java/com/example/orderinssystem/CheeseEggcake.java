...
public class CheeseEggcake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cheese_eggcake);
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(CheeseEggcake.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(CheeseEggcake.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(CheeseEggcake.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
