...
public class EggToast extends AppCompatActivity {
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(EggToast.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(EggToast.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(EggToast.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
