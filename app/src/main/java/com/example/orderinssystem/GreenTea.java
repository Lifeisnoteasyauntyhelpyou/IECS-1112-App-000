...
public class GreenTea extends AppCompatActivity {
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(GreenTea.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(GreenTea.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(GreenTea.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
