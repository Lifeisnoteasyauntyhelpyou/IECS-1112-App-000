...
public class SetMealD extends AppCompatActivity{
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(SetMealD.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(SetMealD.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(SetMealD.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
