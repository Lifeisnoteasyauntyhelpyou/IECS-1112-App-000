...
public class OringinEggcake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oringin_eggcake);
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(OringinEggcake.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(OringinEggcake.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(OringinEggcake.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
