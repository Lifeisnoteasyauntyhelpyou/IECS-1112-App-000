...
public class PotatocakeEggcake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_potatocake_eggcake);
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(PotatocakeEggcake.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(PotatocakeEggcake.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(PotatocakeEggcake.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
