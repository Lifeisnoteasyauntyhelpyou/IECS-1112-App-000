...
public class PorkEggcake extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pork_eggcake);
    ...
    public void saveData(){
        AlertDialog.Builder builder = new AlertDialog.Builder(PorkEggcake.this);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(PorkEggcake.this, "Saved", Toast.LENGTH_LONG).show();
                    finish();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(PorkEggcake.this, e.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
